...
# Tabs
c.colors.tabs.bar.bg = tabs["dark1"]
c.colors.tabs.odd.bg = tabs["dark2"]
c.colors.tabs.even.bg = tabs["dark3"]
...
config.bind("g/", "config-cycle colors.webpage.darkmode.enabled true false")
