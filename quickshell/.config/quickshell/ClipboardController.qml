            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        MouseArea { anchors.fill: parent; cursorShape: Qt.PointingHandCursor; onClicked: root.activeTab = "history" }
                    }
                    Rectangle {
                        Layout.fillWidth: true
                        Layout.preferredHeight: 26
                        ...
                        MouseArea { anchors.fill: parent; cursorShape: Qt.PointingHandCursor; onClicked: root.activeTab = "snippets" }
                    }
                }
